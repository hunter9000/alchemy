...
import alch.interceptor.RolePermissions;
import alch.model.user.Role;
import alch.model.user.RoleType;
import alch.model.user.User;
import alch.repository.RoleRepository;
import alch.repository.UserRepository;
import alch.request.AuthRequest;
import alch.response.StringResponse;
import alch.security.ForbiddenAccessException;
import alch.security.JwtSubject;
import alch.security.SecurityManager;
