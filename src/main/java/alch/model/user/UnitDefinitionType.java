...
public enum UnitDefinitionType {
    ...
    SOURCE_WOOD(UnitType.SOURCE, 0, null, new UnitConnection(ResourceType.WOOD, DirectionType.EAST, false)),
    ...
    STOCKPILE_DIRT(UnitType.STOCKPILE, 50, ResourceType.WOOD, new UnitConnection(ResourceType.DIRT, DirectionType.NORTH, true)),
